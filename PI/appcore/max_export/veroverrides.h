...
#define MAXVER_INTERNALNAME "piexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "piexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "pi engine obj exporter (plugin)\0"//should  be overidden on a per-dll level
