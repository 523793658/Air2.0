...
{
	GENERATED_USTRUCT_BASE(FFontData,)
...
{
	GENERATED_USTRUCT_BASE(FTypefaceEntry, )
...
{
	GENERATED_USTRUCT_BASE(FTypeface, )
...
{
	GENERATED_USTRUCT_BASE(FCompositeFallbackFont,)
...
{
	GENERATED_USTRUCT_BODY(FCompositeSubFont, , FCompositeFallbackFont)
...
{
	GENERATED_USTRUCT_BASE(FCompositeFont,)
