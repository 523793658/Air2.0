...
struct FFocusEvent
{
	GENERATED_USTRUCT_BASE(FFocusEvent, SLATECORE_API)
...
{
	GENERATED_USTRUCT_BASE(FCaptureLostEvent, SLATECORE_API)
...
struct FInputEvent
{
	GENERATED_USTRUCT_BASE(FInputEvent, SLATECORE_API)
...
{
	GENERATED_USTRUCT_BODY(FKeyEvent, SLATECORE_API, FInputEvent)
...
struct FAnalogInputEvent
	: public FKeyEvent
{
	GENERATED_USTRUCT_BODY(FAnalogInputEvent, SLATECORE_API, FKeyEvent)
...
struct FCharacterEvent
	: public FInputEvent
{
	GENERATED_USTRUCT_BODY(FCharacterEvent, SLATECORE_API, FInputEvent)
...
struct FPointerEvent
	: public FInputEvent
{
	GENERATED_USTRUCT_BODY(FPointerEvent, SLATECORE_API, FInputEvent)
public:
...
struct FMotionEvent
	: public FInputEvent
{
	GENERATED_USTRUCT_BODY(FMotionEvent, SLATECORE_API, FInputEvent)
...
struct FNavigationEvent
	: public FInputEvent
{
	GENERATED_USTRUCT_BODY(FNavigationEvent, SLATECORE_API, FInputEvent)
