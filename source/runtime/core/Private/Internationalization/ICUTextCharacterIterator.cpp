...
icu::UCharCharacterIterator* FICUTextCharacterIterator_NativeUTF16::clone() const
{
...
icu::StringCharacterIterator* FICUTextCharacterIterator_ConvertToUnicodeString::clone() const
{
