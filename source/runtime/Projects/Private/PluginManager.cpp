...
{
	const FPluginReferenceDescriptor* MissingPlugin;
	if (!ConfigureEnabledPluginForTarget(FirstReference, IProjectManager::Get().GetCurrentProject(), UE_APP_NAME, FPlatformMisc::GetUBTPlatform(), FApp::GetBuildConfiguration(), FApp::GetBuildTargetType(), (bool)true, AllPlugins, EnabledPlugins, MissingPlugin))
	{
